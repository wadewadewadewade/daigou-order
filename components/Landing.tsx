    ...
    <div style={{ background: "#FFF9F0", minHeight: "100vh", color: "#111111", fontFamily: "inherit" }}>
      ...
      <div style={{ maxWidth: "760px", margin: "0 auto", padding: "0 24px 80px" }}>
        ...
        <section style={{ padding: "72px 0 56px", textAlign: "center" }}>
          ...
          <div style={{ maxWidth: "520px", margin: "0 auto 44px", textAlign: "left", background: "#FFFEF8", borderTop: "2px solid #111111", borderRight: "2px solid #111111", borderBottom: "2px solid #111111", borderLeft: "10px solid #FFE14D", borderRadius: "6px", boxShadow: "4px 4px 0px #111111", padding: "20px 24px" }}>
